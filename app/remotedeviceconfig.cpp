...
RemoteDeviceConfig::RemoteDeviceConfig( Scene *scene, QWidget *parent, GraphicElement *elm ) : QDialog( parent ), ui( new Ui::RemoteDeviceConfig ), scene( scene ), manager(new QNetworkAccessManager(this)) {
  ui->setupUi( this );
...
void RemoteDeviceConfig::setupConfigScreen() {
    ...
    addAction->setIcon(QIcon(":/toolbar/zoomIn.svg"));
    removeAction->setIcon(QIcon(":/toolbar/zoomOut.svg"));

    copyAction->setIcon(QIcon(":/toolbar/copy.svg"));
...
void RemoteDeviceConfig::onTryToConnect() {
    ...
    QString majorVersionStr = versionStr.mid(1, firstDotIndex-1);
